(function($) {
    $(document).ready(function() {
        ...
        // LANGUAGE TOGGLE
        $(".languages a:nth-child(1)").addClass('active');
        $('.languages a').on('click', function() {
            var lang = $(this).data('text');
            $(this).closest('.languages').find('a').removeClass('active');
        ...
        $('a, .sandwich, .swiper-pagination-bullet, .swiper-button-prev, .swiper-button-next, .main-nav').hover(function() {
